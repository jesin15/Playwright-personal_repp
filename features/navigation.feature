Feature: Navigation to WebSite
    ...
    Then User Deletes the Message which was created via API
    Then User Verifes the Message Count should be equal to  intial count.
    ...
    @smoke
    Scenario: Health Check of the WebSite
    Given User Navigates to the Hotel WebSite
    Then User verifies whether we get the status 200 code via API 
